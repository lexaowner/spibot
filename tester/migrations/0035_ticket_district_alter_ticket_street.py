...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tester', '0034_remove_ticket_district'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='ticket',
            name='district',
            field=smart_selects.db_fields.ChainedForeignKey(blank=True, chained_field='region', chained_model_field='region', null=True, on_delete=django.db.models.deletion.CASCADE, to='tester.district'),
        ),
