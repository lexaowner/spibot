...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tester', '0056_alter_ticket_street'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='ticket',
            name='district',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='tester.district', verbose_name='Район'),
        ),
        migrations.AlterField(
            model_name='ticket',
            name='street',
